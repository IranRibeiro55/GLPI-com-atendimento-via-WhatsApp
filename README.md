...
Documentação completa da implantação de um ambiente **GLPI + Bot de WhatsApp**, permitindo abertura e consulta de chamados por WhatsApp com integração via **API REST do GLPI**.
